      ...
      try {
        ...
        if (ethereum) {
          if (!isConnecting) {
            ...
            const contractorAddress="0xac6729d30C9F4aD0945b89917f8d84Ae384E3d1D";
            const contractorABI= ContractorABI.abi;

            const verifiedContractorAddress="0xdC6F46D370D0B40D619CbB02F87532ED11297E2C";
            const verifiedContractorABI= VerifiedContractorABI.abi;

            const dealerAddress="0xf8700E3B3295cD56d9ca3ce138Cf71c14542a43E";
            const dealerABI= DealerABI.abi;

            const dealAddress="0xacB61cDB5C61dB8c3ad96b20D7ddd2917320ae49";
            const dealABI= DealABI.abi;

            const requestAddress="0xD856e738ec91173160da79d1688032e9a76c4FAb";
            const requestABI= RequestABI.abi;

            const sequenceAddress="0x35B704eaD9b7c9096B792bb742Aef362fFC3E586";
            const sequenceABI= SequenceABI.abi;

            const dealNFTAddress="0x1b76a2F15c5658D58D7Ae3299c9bBC7Fb908AD71";
            const dealNFTABI= DealNFTABI.abi;

            const dealFinalAddress="0x319d75DBb017BC6A6B8394DA95E7D5452c35B6f4";
